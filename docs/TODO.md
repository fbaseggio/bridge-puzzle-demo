...
## 20260506
- [ ] Write a short “adding a new puzzle/article widget” validation checklist covering: puzzle registry entry, `npm run puzzles:validate`, targeted Vitest seams, `npm run build`, and manual widget/page checks.
- [ ] Review all stale todos.

## Pre-April possibly stale
